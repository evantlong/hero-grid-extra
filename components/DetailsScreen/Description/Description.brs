...
Sub Init()
  ...
  m.top.UserStarRating    = m.top.findNode("UserStarRating")
  m.top.StarRating        = m.top.findNode("StarRating")
End Sub
...
Sub OnContentChanged()
  ...
  value = item.UserStarRating
  '	if value <> invalid then
	'  if value <> ""
	 '   m.top.UserStarRating.text = value.toStr()
	 ' else
	'    m.top.UserStarRating.text = "No Rating Yet"
     ' end if
  ' end if
